   ...
   public static WebDriver driver;
    ...
    public  void setup(String browser) throws InterruptedException {
        if (browser.equalsIgnoreCase("Chrome")) {
            System.setProperty("webdriver.chrome.driver", "C:\\Users\\gresh\\IdeaProjects\\Testngsample\\chromedriver.exe");
            ...
            System.setProperty("webdriver.ie.driver", "C:\\Users\\gresh\\IdeaProjects\\Testngsample\\IEDriverServer.exe");
  ...
  @Test(priority = 5)
    ...
    public void footer(){
       ...
       WebElement element= driver.findElement(By.xpath("//div[@class='row']/div/h4"));
        ...
        footer.add("BOOKMYSHOW APP ");
        footer.add("BOOKMYSHOW NEWS");
